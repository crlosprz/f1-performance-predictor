...
model_top10 = joblib.load(os.path.join(MODELS_DIR, "model_top10.joblib"))
model_top5 = joblib.load(os.path.join(MODELS_DIR, "model_top5.joblib"))
model_top3 = joblib.load(os.path.join(MODELS_DIR, "model_top3.joblib"))
model_victory = joblib.load(os.path.join(MODELS_DIR, "model_victory.joblib"))
...
prob_top10 = model_top10.predict_proba(input_data)[0][1]
prob_top5 = model_top5.predict_proba(input_data)[0][1]
prob_top3 = model_top3.predict_proba(input_data)[0][1]
prob_victory = model_victory.predict_proba(input_data)[0][1]
